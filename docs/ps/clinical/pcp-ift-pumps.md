---
title: PCP interfacility Transfers w/ IV Pumps
policy_id: 
version: 1.0
status: Active
...
# PCP IFT with IV Pumps <br> <span style="font-size: 0.8em; font-style: italic;">Decision Support Tool</span>
...
a) **6 Rs of medication administration:**
Patient, Time, Dose, Drug, Route, Documentation.
...
c) **Library infusions:** Using the library is preferred practice and _mandatory_ when the 
drug being used is programmed. PCPs will use the PCP library for some in-scope medications and generic fluid administration. The CCP/IFT library will be used for out-of-scope medications being delivered.

c) **High Alert medications:**
 Medications that come with the potential for increased harm and require additional care. High Alert medications that may be given by PCPs include opioids, heparin, and epinephrine.
...
[B. Braun Infusomat® Space® Pump Manual](https://intranet.bcehs.ca/mlink/file/NjkzNjg?type=attachment){:target="_blank .external-link}
